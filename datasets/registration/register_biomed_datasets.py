...
datasets = ['fetal-head' ]   # provide name of the dataset under biomedparse_datasets
splits = ['train']    # provide split name, e.g., train, test, val. Here there is only one 'demo' split in the example demo dataset
